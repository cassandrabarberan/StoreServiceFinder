...
// $cus = $mydb->loadSingleResult();
 ...
 $sql = "SELECT `UserID`, `FullName`, `Username`, `Password`, `Role`, `PicLoc` FROM `tblusers` WHERE `FullName` = '{$res->MessageFrom}'";
$mydb->setQuery($sql);
$ResultStore = $mydb->loadSingleResult();
              ...
              <div class="mailbox-read-message">
                <div class="direct-chat-messages"> 
                  <div class="direct-chat-msg right">
                          ...
                          <img class="direct-chat-img" src="<?php echo web_root.'customer/'.$customer->Customer_Photo; ?>" alt="Message User Image"> 
                  ...
                  $position="";
                    ...
                    foreach ($repResult as $row) {
                      // code... 
                      $storename = trim($row->CreatedBy);
                      // echo $storename;

$sql = "SELECT `UserID`, `FullName`, `Username`, `Password`, `Role`, `PicLoc` FROM `tblusers` WHERE `FullName`='{$storename}'";
$mydb->setQuery($sql);
...
<div class="direct-chat-msg  ">
                          ...
                          <img class="direct-chat-img" src="<?php echo web_root.'admin/user/'. $str->PicLoc;?>" alt="Message User Image"> 
                          <div class="direct-chat-text">
...
<div class="direct-chat-msg <?php echo $position;?>">
    ...
    <img class="direct-chat-img" src="<?php echo web_root.'customer/'.$customer->Customer_Photo; ?>" alt="Message User Image"> <div class="direct-chat-text">
     <?php echo $row->ReplyText ?>
    </div> 
  </div>
  ...
  <?php 
            ...
            <div class="box-footer"> 
                <a href="index.php?view=reply&store=<?php  echo $res->MessageFrom; ?>&id=<?php echo $id;?>" id="btnReplyMessage" class="btn btn-default"><i class="fa fa-reply"></i> Reply</a>
