...
<div class="wrapper">
  ...
  <header class="main-header" style="background:#00bcd4;">
    <!-- Logo -->
    <a style="background:#00bcd4; padding:0px 10px;" href="<?php echo web_root;?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>S&SF</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="background:#00bcd4;"><b>Store&Service Finder</b></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" role="navigation" style="background:#00bcd4;">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">You have <?php echo $number_notif; ?> message(s)</li>
              <li> 
                <ul class="menu">

                  <?php
                   $sql ="SELECT `MessageID`, `MessageFrom`, `MessageTo`, `MessageSubject`, `MessageText`, `MessageDate` FROM `tblmessages` WHERE `MessageTo` LIKE '%". $singleuser->FullName."%' ORDER BY `MessageDate` DESC";
                   // }
                     $mydb->setQuery($sql);
                     $cur = $mydb->loadResultList();
                   ...
                   foreach ($cur as $result) { 
                       ...
                       echo '<li>
                         <a href="'.web_root.'admin/messages/index.php?view=readmessage&id='.$result->MessageID.'">
                           <i class="fa fa-user text-aqua"></i> '.$result->MessageFrom.'   <span class="mailbox-read-time pull-right">' .  date_format(date_create($result->MessageDate),'d M. Y h:i a').'</span>
                         </a>
                       </li>'; 
                   }
                    ?>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
    ...
    <section class="sidebar">
      ...
      <?php } ?>
        ...
        <li class="<?php echo (currentpage() == 'messages') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/messages/">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">storefinderzamboanga</a>.</strong> All rights
    reserved.
  </footer>
