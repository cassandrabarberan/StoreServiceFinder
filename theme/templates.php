...
<head>
  <meta charset="utf-8">
  <title>A WEB BASED STORE LOCATOR / <?php echo $title; ?></title>
...
<body>
            ...
            <div class="col-md-12">
              ...
              <div class="pull-right login">
                ...
                if (isset($_SESSION['CustomerID'])) {
                  ...
                  $sql = "SELECT SUM(`Remaining`) as Remain FROM `tblstockin` p,`tblwishlist` w WHERE p.`ProductID`=w.`ProductID` AND `CustomerID`='" . $_SESSION['CustomerID'] . "' GROUP BY p.`ProductID`";
                  $mydb->setQuery($sql);
                  ...
                  echo '<a title="View Message(s)" href="' . web_root . 'customer/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-success">' . ($msg + $maxrow) . '</span></a> | <a title="View Profile" href="' . web_root . 'customer/"> <i class="fa fa-user"></i> Hello, ' . $cus->CustomerName . ' </a> | <a href="' . web_root . 'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> ';
                } else { ?>
        ...
        <div id="navbar" class="navbar navbar-default navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- <a class="navbar-brand" href= ""><font size= "02.05">A Web Based Store locator</font></a>  -->
            </div>
            <div class="navbar-collapse collapse ">
              <ul class="nav navbar-nav">
                <li class="<?php echo !isset($_GET['q']) ? 'active' : '' ?>"><a href="<?php echo web_root; ?>index_1.php">Home</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                            ...
                            }  ?>"><a href="<?php echo web_root; ?>index_1.php?q=product">Products</a></li>
                ...
                <li class="<?php if (isset($_GET['q'])) {
                            ...
                            }  ?>"><a href="<?php echo web_root; ?>index_1.php?q=company">Store</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'nearstore') {
                                echo 'active';
                              } else {
                            ...
                            }  ?>"><a href="<?php echo web_root; ?>index_1.php?q=nearstore"><i class="fa fa-search"></i> Store Near You</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'map') {
                                echo 'active';
                              } else {
                            ...
                            } ?>"><a href="<?php echo web_root; ?>index_1.php?q=map">Map</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'About') {
                                echo 'active';
                              } else {
                            ...
                            }  ?>"><a href="<?php echo web_root; ?>index_1.php?q=About">About Us</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'Contact') {
                                echo 'active';
                              } else {
                            ...
                            }  ?>"><a href="<?php echo web_root; ?>index_1.php?q=Contact">Contact</a></li>
                <?php
                $rq = isset($_GET['q']) ?  $_GET['q'] : "";

                if ($rq != 'advancesearch' && $rq != 'search/store' && $rq != 'search/category') { ?>

                  <form autocomplete="off" method="POST" action="<?php echo web_root; ?>index_1.php?q=result&searchfor=advancesearch" style="padding: 0px 20px 0px 5px;">
                    <div class="input-group autocomplete">
                      <input type="text" name="SEARCH" id="tags" class="form-control" placeholder="Search Product">
  ...
  <script type="text/javascript">
    $('input.ContactNo').on('keyup', function() {
      limitText(this, 11)
    });
