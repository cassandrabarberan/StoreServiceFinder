...
<body>
  <div id="wrapper" class="home-page" style="">
            ...
            <div class="navbar-collapse collapse ">
              <ul class="nav navbar-nav">
                ...
                <li class="<?php if (isset($_GET['q'])) {
                            ...
                            } ?>"><a href="<?php echo web_root; ?>index.php?q=map">Map</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'About') {
                                echo 'active';
                              } else {
                ...
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'register/customer') {
                                echo 'active';
                              } else {
                                echo '';
                              }
                            }  ?>"><a href="<?php echo web_root; ?>index.php?q=register/customer">Customer Signup</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'register/store') {
                                echo 'active';
                              } else {
                                echo '';
                              }
                            }  ?>"><a href="<?php echo web_root; ?>index.php?q=register/store">Store Signup</a></li>
                <li class="<?php if (isset($_GET['q'])) {
                              if ($_GET['q'] == 'fa fa-lock') {
                                echo 'active';
                              } else {
                                echo '';
                              }
                            }  ?>"><a data-target="#myModal" data-toggle="modal" href=""><i class="fa fa-lock" id="lock"></i> Login</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <footer>
      ...
      <div id="sub-footer">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="copyright" style="padding-left:39.5px;">
                <p>
